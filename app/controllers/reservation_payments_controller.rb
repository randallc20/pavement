  ...
  def create
    ...
    reservation =
      Reservation.create(
        ...
        checkin_date:
          Date.strptime(
            payment_params[:checkin_date],
            Date::DATE_FORMATS[:us_short_date]
          ),
        checkout_date:
          Date.strptime(
            payment_params[:checkout_date],
            Date::DATE_FORMATS[:us_short_date]
          )
      )
    payment =
      Payment.create(
        ...
        cleaning_fee:
          Money.from_amount(BigDecimal(payment_params[:cleaning_fee])),
        service_fee:
          Money.from_amount(BigDecimal(payment_params[:service_fee])),
